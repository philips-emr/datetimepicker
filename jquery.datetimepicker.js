		...
		createDateTimePicker = function (input) {
						...
						while (i < _xdsoft_datetime.currentTime.countDaysInMonth() || start.getDay() !== options.dayOfWeekStart || _xdsoft_datetime.currentTime.getMonth() === start.getMonth()) {
							...
							if (_xdsoft_datetime.currentTime.getMonth() !== m) {
								classes.push('xdsoft_other_month');
                                                        ...
                                                        //note: On Datapicker with 'yyyy' format there is no day to make a conversion to the present day, then in this case there will be no current day class. This is why was add a day check verification.
							if ((options.defaultSelect || datetimepicker.data('changed')) && _xdsoft_datetime.currentTime.dateFormat(options.formatDate) === start.dateFormat(options.formatDate) && (options.formatDate.indexOf('d') > -1)) {
							...
							var mesIncrementado = m+1;

							table += '<td id="' + d + '_' + mesIncrementado + '_' + y + '" data-date="' + d + '" data-month="' + m + '" data-year="' + y + '"' + ' class="xdsoft_date xdsoft_day_of_week' + start.getDay() + ' ' + classes.join(' ') + '" title="' + description + '">' +
										'<div>' + d + '</div>' +
									'</td>';
			...
			input
				...
				.on('open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart', function (event) {
					if (input.is(':disabled') || (input.data('xdsoft_datetimepicker').is(':visible') && options.closeOnInputClick) || input.attr('keepclose') == 'true') {
						if (input.attr('keepclose')) input.removeAttr('keepclose');
						return;
					}
					clearTimeout(timer);
